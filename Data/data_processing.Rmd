...
typology_unproc <- st_make_valid(read_sf("unprocessed_data/boundaries/Typology/mun_typology.shp"))
...
# Add zeros for NA values, make sure all names are english in all files
