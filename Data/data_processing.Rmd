...
```{r}
# German --> English
type_names <- c("Big Centers", "Secondary Centers Of Big Benters", "Crown Big Centers", "Medium Centers", "Crown Medium Centers", "Small Centers", "Peri-urban Rural Communes", "Agricultural Communes", "Tourist Communes")
...
ch_installed_pot_simplified <- st_simplify(ch_installed_pot, preserveTopology = T, dTolerance=250)
```

```{r}
ggplot() +
  geom_sf(data= muns_installed_pot_simplified, aes(fill=kw_tot/pop), lwd=0.1) +
  theme_void()
```

```{r}
ggplot() +
  geom_sf(data= muns_installed_pot_simplified, aes(fill=p_rf), lwd=0.01) +
  theme_void()
```

```{r}
ggplot() +
  geom_sf(data= typ_installed_pot_simplified, aes(fill=p_rf), lwd=0.01) +
  theme_void()
```
...
```{r}
ggplot() +
  geom_sf(data= cantons_installed_pot_simplified, aes(fill=kw_tot/pop), lwd=0.1) +
  theme_void()
```

```{r}
ggplot() +
  geom_sf(data= cantons_installed_pot_simplified, aes(fill=p_rf), lwd=0.01) +
  theme_void()
```

```{r}
ggplot() +
  geom_sf(data= typ_installed_pot_simplified, aes(fill=kw_tot/pop), lwd=0.1) +
  theme_void()
```
